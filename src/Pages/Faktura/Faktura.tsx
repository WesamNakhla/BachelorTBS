                    ...
                    <Modal>
                        <div className="flex flex-col">
                            ...
                            <div className="flex font-lexend">
                                <button type="button" className="w-[170px] h-[50px] border-1 border-[#A2A1A8]/20 rounded-md">Cancel</button>
                                <button type="button" className="w-[170px] h-[50px] text-[#fff] bg-[#7152F3] border-1 border-[#A2A1A8]/20 rounded-md !ml-4">Add</button>
                            </div>
                        </div>
                    </Modal>
            }
